...
class TicketManager extends BaseModel
{
	...
	public function createNewTickt()
	{
	...
	{
		$query = 'select t.price, ce.name, cw.name, h.label, s.seat_column, s.seat_row, ce.name as cen from theatre.ticket as t join theatre.user on t.id_user = user.id
