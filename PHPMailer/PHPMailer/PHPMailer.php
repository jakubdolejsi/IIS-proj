...
class PHPMailer
{
	 ...
	 *                     where each recipient is a 2-element indexed array with element 0 containing an
	 *                     address and element 1 containing a name, like:
	 ...
	 * $basedir is prepended when handling relative URLs, e.g. <img src="/images/a.png"> and must not be
	 * empty
	 * will look for an image file in $basedir/images/a.png and convert it to inline.
	 * If you don't provide a $basedir, relative paths will be left untouched (and thus probably break in
	 * email) Converts data-uri images into embedded attachments. If you don't want to apply these
	 * transformations to your HTML, just set Body and AltBody directly.
	 * @param string        $message  HTML message string
	 * @param string        $basedir  Absolute path to a base directory to prepend to relative paths to
	 *                                images
	 * @param bool|callable $advanced Whether to use the internal HTML to text converter
	 *                                or your own custom converter @return string $message The transformed
	 *                                message Body
	 * @throws Exception
	 ...
	 * @see http://www.andrew.cmu.edu/user/agreen1/testing/mrbs/web/Mail/RFC822.php A more careful
	 *      implementation
